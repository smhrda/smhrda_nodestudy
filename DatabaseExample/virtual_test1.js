...
function connectDB() {
  ...
  database.on(
    "error",
    console.error.bind(console, "mongoose conenction error.")
  );
...
function doTest() {
  // UserModel 인스턴스 생성
  // id, name 할당 X, info만 할당
  var user = new UserModel({ info: "test01 테스트1" });
